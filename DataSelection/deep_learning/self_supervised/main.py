...
from DataSelection.deep_learning.self_supervised.datamodules.utils import create_ssl_data_modules
from DataSelection.deep_learning.self_supervised.simclr_module import SimCLRIE
from DataSelection.deep_learning.self_supervised.ssl_classifier_module import (SSLOnlineEvaluatorIE,
                                                                                     get_encoder_output_dim)
from DataSelection.deep_learning.utils import load_ssl_model_config
from DataSelection.utils.default_paths import EXPERIMENT_DIR
...
def cli_main(config: ConfigNode, debug: bool = False) -> None:
    ...
    if ssl_type == "simclr":
        model = SimCLRIE(num_samples=dm.num_samples,  # type: ignore
    ...
    # Create BYOL model
        ...
        model = BYOLIE(num_samples=dm.num_samples,  # type: ignore
    ...
    online_eval = SSLOnlineEvaluatorIE(class_weights=dm.class_weights,  # type: ignore
