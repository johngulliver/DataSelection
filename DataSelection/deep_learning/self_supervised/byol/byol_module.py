...
from DataSelection.deep_learning.self_supervised.byol.byol_models import SiameseArm
from DataSelection.deep_learning.self_supervised.byol.byol_moving_average import BYOLMAWeightUpdate
...
class BYOLIE(pl.LightningModule):
    """
