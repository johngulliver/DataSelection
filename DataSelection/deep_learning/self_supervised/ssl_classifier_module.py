...
from DataSelection.deep_learning.self_supervised.metrics import AreaUnderRocCurve
from pytorch_lightning.metrics import Accuracy


BatchType = Tuple[List, T]

class SSLOnlineEvaluatorIE(SSLOnlineEvaluator):
...
def get_encoder_output_dim(pl_module: Union[pl.LightningModule, torch.nn.Module],
    ...
    if dm is not None:
        ...
        x, _ = SSLOnlineEvaluatorIE.to_device(batch, device)
    else:
