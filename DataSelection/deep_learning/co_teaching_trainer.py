...
from DataSelection.deep_learning.collect_embeddings import get_all_embeddings
from DataSelection.deep_learning.graph.classifier import GraphClassifier
from DataSelection.deep_learning.loss import CrossEntropyLoss, consistency_loss
from DataSelection.deep_learning.model_trainer_base import IndexContainer, Loss, ModelTrainer
from DataSelection.deep_learning.scheduler import ForgetRateScheduler
from DataSelection.deep_learning.utils import create_model
from DataSelection.utils.generic import find_union_set_torch, map_to_device
...
class CoTeachingTrainer(ModelTrainer):
    ...
    def __init__(self, config: ConfigNode):
        ...
        self.graph_classifiers = [GraphClassifier(num_samples=len(self.train_loader.dataset),
